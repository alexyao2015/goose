...
export const getPendingRequests = <ThrowOnError extends boolean = false>(options?: Options<GetPendingRequestsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetPendingRequestsResponses, GetPendingRequestsErrors, ThrowOnError>({
        url: '/sampling/pending',
        ...options
    });
};

export const approveSamplingRequest = <ThrowOnError extends boolean = false>(options: Options<ApproveSamplingRequestData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApproveSamplingRequestResponses, ApproveSamplingRequestErrors, ThrowOnError>({
